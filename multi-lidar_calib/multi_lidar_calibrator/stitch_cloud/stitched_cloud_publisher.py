...
fields = [
            ...
            PointField(name='y', offset=4, count=1,  
                       datatype=PointField.FLOAT32),
            PointField(name='z', offset=8, count=1,
                       datatype=PointField.FLOAT32),
            PointField(name='intensity', offset=12, count=1,
                       datatype=PointField.FLOAT32)
        ]
...
class StitchedCloudPublisher(Node):
    ...
    def pointcloud_callback(self, msg: PointCloud2, lidar_name: str):
        ...
        try:
            ...
            # 重建标准化点云消息
            new_msg = rnp.msgify(PointCloud2, structured_arr)
    ...
    def publish_stitched_cloud(self):
        ...
        try:
            ...
            stitched_msg.header.frame_id = "stitch" #self.target_lidar
